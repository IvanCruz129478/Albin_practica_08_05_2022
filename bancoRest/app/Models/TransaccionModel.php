...
class TransaccionModel extends Model
{
    ...
    protected $validationMessages = [
        ...
        'tipo_transaccion_id'   => [
            'is_valid_tipo_transaccion' => 'Estimado usuario, debe ingresar un tipo de transaccion valido'
        ]
    ];
    ...
    public function TransaccionesPorCliente($clienteId = null)
    {
        ...
        $builder->select('tipo_transaccion.description AS Tipo, transaccion.monto, transaccion.created_at AS FechaTransaccion');
